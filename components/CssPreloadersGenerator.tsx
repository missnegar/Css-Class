...
const CssPreloadersGenerator: React.FC = () => {
                ...
                <ResizablePanels>
                    ...
                    <aside className="w-full bg-white dark:bg-slate-800/50 border-t md:border-l md:border-t-0 border-slate-200 dark:border-slate-800 flex flex-col overflow-y-auto no-scrollbar">
                        <div className="p-4 border-b border-slate-200 dark:border-slate-800 shrink-0">
                             <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-3">انواع پیش‌بارگذار</h3>
...
export default CssPreloadersGenerator;